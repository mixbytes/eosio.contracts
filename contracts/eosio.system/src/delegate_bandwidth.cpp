...
namespace eosiosystem {
   ...
   struct [[eosio::table, eosio::contract("haya.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      asset         vote_weight;
    ...
    */
   struct [[eosio::table, eosio::contract("haya.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("haya.system")]] refund_request {
      name            owner;
